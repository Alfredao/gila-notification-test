...
final class Version20230307061831 extends AbstractMigration
{
    ...
    : void
    {
        ...
        $table->addColumn('broadcast_id', 'integer', ['unsigned' => true, 'notnull' => true]);
        ...
        $table->addForeignKeyConstraint('broadcast', ['broadcast_id'], ['id'], ['onDelete' => 'CASCADE'], 'fk_message_broadcast');
